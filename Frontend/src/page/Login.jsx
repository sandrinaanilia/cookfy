...
<div className="flex flex-col items-start justify-center p-8">
  ...
  <p className="text-gray-600 text-left mt-2 font-encode">
    Ayo coba, sajikan menu favorit dengan sentuhan personal!
          ...
          {/* Divider */}
          <div className="flex text-center items-center my-6 w-full">
      ...
      <div className="flex flex-col font-center items-center justify-center mt-4">
          <p className="text-center text-sm text-gray-600 font-encode">
              Belum punya akun?{" "}
              <a href="#" className="text-[#5956A9] text-center hover:underline font-encode">
                  Daftar
              </a>
          </p>
      </div>
